                ...
                child: FutureBuilder(
                    ...
                    builder: (_, AsyncSnapshot snapshot) {
                        ...
                        default:
                         ...
                         Column(crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          CustomContainer(
                                            ...
                                            text: '${controller!.count.value}'+snapshot.data['income'].toString()+'\nTotal Income',
                                          ),
                                          CustomContainer(
                                            height: height,
                                            width: width,
                                            ...
                                            text: '${controller!.count.value}'+snapshot.data['expense'].toString()+'\nTotal Expense',
                                          ),
                                          CustomContainer(
                                            height: height,
                                            width: width,
                                            ...
                                            text: '${controller!.count.value}'+snapshot.data['saving'].toString()+'\nTotal Savings',
                                          ),
                                        ],
                                      ),
                                    ),
                                ...
                                snapshot.data['categoryIncome'].length>0? Padding(
                      ...
                      child: Center(child: Text("No tranaction yet",style: TextStyle(color: Colors.white,fontWeight: FontWeight.w500),)),
                                ...
                                snapshot.data['categoryExpense'].length>0?    Padding(
                                  padding: const EdgeInsets.all(16.0),
                                  child: Text("Expenses",style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold),),
                                ):Container(),
