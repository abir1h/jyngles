...
class Transactions extends StatefulWidget {
  ...
  const Transactions({Key? key,required this.selected_index}) : super(key: key);
...
class _BillListState extends State<BillList> {
  ...
  Widget build(BuildContext context) {
    ...
    widget.billName.length > 20 ? '${ widget.billName.substring(0, 12)}......' :  widget.billName,
                    ...
                    Text(
                      '${controller!.count.value}' + ' ${widget.billAmount}',
                      style:  TextStyle(
...
class BillList2 extends StatelessWidget {
   BillList2({
    Key? key,
    required this.width,
    required this.height,
            ...
            children: [
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    //!Check book icon
                    Image.network(AppUrl.picurl+image,height: 30,width: 30,),
